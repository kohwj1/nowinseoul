...
def get_locale():
    ...
    path_lang = request.view_args.get('locale')
    if path_lang in app.config['BABEL_SUPPORTED_LOCALES']:
        return path_lang
...
def index(locale):
    ...
    page_language = locale # browser locale 값이 기본값
...
# 상세 페이지
@main.route('/detail/<attraction_id>', methods = ['GET','POST'])
